            ...
            <Link href={WEBSITE_PRODUCT_DETAILS(product.slug)}>
                ...
                <div className="p-3 border-t">
                    ...
                    <p className='flex gap-2 text-sm mt-2'>
                        <span className='line-through text-gray-400'>{product?.mrp.toLocaleString('en-IN', { style: 'currency', currency: 'PKR' })}</span>
                        <span className='font-semibold'>{product?.sellingPrice.toLocaleString('en-IN', { style: 'currency', currency: 'PKR' })}</span>
                    </p>
                </div>
            </Link>
        </div>
