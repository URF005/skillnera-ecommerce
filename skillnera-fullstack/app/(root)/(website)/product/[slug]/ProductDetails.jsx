            ...
            <div className="md:flex justify-between items-start lg:gap-10 gap-5 mb-20">
                ...
                <div className="md:w-1/2 md:mt-0 mt-5">
                    ...
                    <div className="flex items-center gap-2 mb-3">
                        <span className="text-xl font-semibold">{variant.sellingPrice.toLocaleString('en-IN', { style: 'currency', currency: 'PKR' })}</span>
                        <span className="text-sm line-through text-gray-500">{variant.mrp.toLocaleString('en-IN', { style: 'currency', currency: 'PKR' })}</span>
