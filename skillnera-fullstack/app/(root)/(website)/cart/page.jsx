                                ...
                                {cart.products.map(product => (
                                    <tr key={product.variantId} className='md:table-row block border-b'>
                                        ...
                                        <td className='md:table-cell flex justify-between md:p-3 px-3 pb-2 text-center'>
                                            ...
                                            <span>
                                                {product.sellingPrice.toLocaleString('en-IN', { style: 'currency', currency: 'PKR' })}
                                            </span>
                                        </td>
                                        ...
                                        <td className='md:table-cell flex justify-between md:p-3 px-3 pb-2 text-center'>
                                            ...
                                            <span>
                                                {(product.sellingPrice * product.qty).toLocaleString('en-IN', { style: 'currency', currency: 'PKR' })}
                                            </span>
                                        </td>
