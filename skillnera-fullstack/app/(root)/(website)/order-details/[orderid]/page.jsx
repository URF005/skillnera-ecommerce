                                ...
                                {orderData && orderData?.data?.products?.map((product) => (
                                    <tr key={product.variantId._id} className="md:table-row block border-b">
                                        ...
                                        <td className="md:table-cell flex justify-between md:p-3 px-3 pb-2 text-center">
                                            ...
                                            <span>{product.sellingPrice.toLocaleString('en-IN', { style: 'currency', currency: 'PKR' })}</span>
                                        </td>
                                        <td className="md:table-cell flex justify-between md:p-3 px-3 pb-2 text-center">
                                        ...
                                        <td className="md:table-cell flex justify-between md:p-3 px-3 pb-2 text-center">
                                            ...
                                            <span>{(product.qty * product.sellingPrice).toLocaleString('en-IN', { style: 'currency', currency: 'PKR' })}</span>
                                        </td>
                                    </tr>
                                ))}
                            </tbody>
                                    ...
                                    <table className="w-full">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td className="text-end py-2">{orderData?.data?.subtotal.toLocaleString('en-IN', { style: 'currency', currency: 'PKR' })}</td>
                                            </tr>
                                            <tr>
                                                <td className="font-medium py-2">Discount</td>
                                                <td className="text-end py-2">{orderData?.data?.discount.toLocaleString('en-IN', { style: 'currency', currency: 'PKR' })}</td>
                                            </tr>
                                            <tr>
                                                <td className="font-medium py-2">Coupon Discount</td>
                                                <td className="text-end py-2">{orderData?.data?.couponDiscountAmount.toLocaleString('en-IN', { style: 'currency', currency: 'PKR' })}</td>
                                            </tr>
                                            <tr>
                                                <td className="font-medium py-2">Total</td>
                                                <td className="text-end py-2">{orderData?.data?.totalAmount.toLocaleString('en-IN', { style: 'currency', currency: 'PKR' })}</td>
                                            </tr>
