            ...
            <SheetContent className="sm:max-w-[450px] w-full">
                ...
                <div className="h-[calc(100vh-40px)] pb-10 ">
                            ...
                            <div key={product.variantId} className="flex justify-between items-center gap-5 mb-4 border-b pb-4">
                                ...
                                <div>
                                    ...
                                    <p className="font-semibold">
                                        {product.qty} X {product.sellingPrice.toLocaleString('en-IN', { style: 'currency', currency: 'PKR' })}
                                    </p>
                    ...
                    <div className="h-32 border-t pt-5 px-2">
                        <h2 className="flex justify-between items-center text-lg font-semibold"><span >Subtotal</span> <span>{subtotal?.toLocaleString('en-IN', { style: 'currency', currency: 'PKR' })}</span></h2>
                        <h2 className="flex justify-between items-center text-lg font-semibold"><span >Discount</span> <span>{discount?.toLocaleString('en-IN', { style: 'currency', currency: 'PKR' })}</span></h2>
